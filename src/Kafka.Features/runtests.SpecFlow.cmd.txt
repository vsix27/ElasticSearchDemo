...
cd bin\Debug\
START /WAIT "nunit-console.exe /labels /out=TestResult.txt /xml=TestResult.xml %name%.dll"
::nunit-console.exe|more /labels /out=TestResult.txt /xml=TestResult.xml %name%.dll
::nunit-console.exe|echo /labels /out=TestResult.txt /xml=TestResult.xml %name%.dll
